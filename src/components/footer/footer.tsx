...
function Footer() {
	return (
		<footer className={styles.section}>
			<u className={styles.social_Icon}>
				<li><span className={styles.material_symbols_outlined}> home </span></li>
				<li><a href="#"></a> 2</li>
				<li><a href="#"></a> 3</li>
				<li><a href="#"></a> 4</li>
			</u>
			<ul className={styles.menu}>
				<li>
					<Link 
						...
						className={styles.footerElements}> Contacto
					</Link>
				</li>
				<li>
					<Link 
						href="/"
						className={styles.footerElements}> Devtics 
					</Link>
				</li>
				<li>
					<Link
